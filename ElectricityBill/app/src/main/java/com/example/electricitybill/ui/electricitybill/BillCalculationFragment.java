...
public class BillCalculationFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        requireActivity().setTitle(R.string.ElectricityTension);
    ...
    private void calculateBill() {
        ...
        if (rebate < 0 || rebate > 5) {
            txtResult.setText("Rebate percentage only available between 0% - 5%.");
            return;
        }
        ...
        // Display result
        txtResult.setText(String.format("Total Price: RM%.2f\nAfter Rebate: RM%.2f", totalCost, finalCost));
    }
